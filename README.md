...
## Installation
To download the module extension, download and extract the zip file HistologyTrialModule. Main code for execution is in HistologyTrialModule.py. The VGG16 model can be downloaded as VGG16_binary_classification.keras. Move it into the Resources folder in HistologyTrialModule and is called upon in the Pycharm file to run binary classification of input data.
